        ...
        <>
          ...
          >
            <div className="mb-2 flex items-center justify-end px-2 py-2">
              <button
                onClick={onClose}
                className="flex h-8 w-8 items-center justify-center rounded-lg text-font-muted hover:bg-background-secondary hover:text-font"
              >
                <RxCross2 size={20} />
              </button>
            </div>
              ...
              {navigation.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`block rounded-xl border-l-2 px-3 py-2.5 text-sm font-medium transition-colors ${
                      isActive
            ...
            <a
              ...
              className="flex items-center gap-2 rounded-xl px-3 py-2.5 text-sm font-medium text-font-muted hover:bg-background-secondary hover:text-font"
            >
              <FaGithub size={17} />
              GitHub
            </a>
